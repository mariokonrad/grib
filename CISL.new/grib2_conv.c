...
static int map_parameter_oceanographic(int center, int disc, int param_cat, int param_num)
{
	...
	switch (param_cat) {
		...
		case 2: /* ice parameters */
			...
			break;
		case 3: /* surface properties parameters */
			switch (param_num) {
				case 0: return 80;
				case 1: return 82;
				default: break;
			...
			break;
		case 4: /* sub-surface properties parameters */
			switch (param_num) {
				case 0: return 69;
				case 1: return 70;
				case 2: return 68;
...
{
	switch (disc) {
		case  0: return map_parameter_meterological(center, disc, param_cat, param_num);
		case  1: return map_parameter_hydrological(center, disc, param_cat, param_num);
		case  2: return map_parameter_landsurface(center, disc, param_cat, param_num);
		case 10: return map_parameter_oceanographic(center, disc, param_cat, param_num);
		default: break;
	}
...
static void map_level_data(GRIB2Grid * grid, int * level_type, int * level1, int * level2, int center)
{
...
static void map_time_range(GRIBMessage * msg, GRIB2Grid * grid, int * p1, int * p2, int * t_range, int * n_avg, int * n_missing, int center)
{
...
void grib2_packPDS(GRIBMessage * msg, int grid_number, unsigned char * grib1_buffer, size_t *offset)
{
	...
	/* parameter code */
	set_bits(grib1_buffer,
		map_parameter_data(msg->center_id,msg->disc,msg->grids[grid_number].md.param_cat,msg->grids[grid_number].md.param_num),
		*offset+64,8);
